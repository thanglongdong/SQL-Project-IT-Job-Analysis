...
COPY company_dim
FROM 'C:\Users\thang\OneDrive\Documents\SQL Project IT Job Analysis\cvs_files\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\Users\thang\OneDrive\Documents\SQL Project IT Job Analysis\cvs_files\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\Users\thang\OneDrive\Documents\SQL Project IT Job Analysis\cvs_files\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\Users\thang\OneDrive\Documents\SQL Project IT Job Analysis\cvs_files\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
